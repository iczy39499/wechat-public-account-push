export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx67084a4cf067925b",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c575057909b86636e57b3ba095d9c2c5",
   ...
   */
  USERS: ["o2gUg5un4K9V6cvFxle82Hvei7nw"]
    {
      // 想要发送的人的名字
      name: "老婆0",
  ...
  CALLBACK_TEMPLATE_ID: "YLjN5ij4IVmBNKKclCXBbemVNyvUi58pDQ1WSkXY3no",

  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: ["o2gUg5un4K9V6cvFxle82Hvei7nw"]
    {
      // 一般都填自己
      name: "自己",
      // 自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o2gUg5un4K9V6cvFxle82Hvei7nw",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
